...
object ProcessorConstants {
    ...
    const val REQUIRES_SETTING_ANNOTATION = "$ANNOTATION_PACKAGE.RequiresSetting"
    const val REQUIRES_LOCK_ANNOTATION = "$ANNOTATION_PACKAGE.RequiresLock"
    ...
    const val PLUGIN_LOCKS_ANNOTATION = "$ANNOTATION_PACKAGE.PluginLocks"
