 ...
 *
 * A class annotated with `@PluginInfo` must also implement [com.wip.plugin.api.DataProcessor].
 * The KSP processor will generate the necessary [com.wip.plugin.api.PluginEntry] implementation and
