 ...
 * @property isAdvanced Whether this parameter is hidden by default under advanced options.
 */
 ...
 * @property isAdvanced Whether this input location is hidden by default under advanced options.
 */
@Target(AnnotationTarget.VALUE_PARAMETER, AnnotationTarget.PROPERTY)
@Retention(AnnotationRetention.SOURCE)
 ...
 * @property isAdvanced Whether this output location is hidden by default under advanced options.
 */
@Target(AnnotationTarget.VALUE_PARAMETER, AnnotationTarget.PROPERTY)
@Retention(AnnotationRetention.SOURCE)
...
/**
 * Declares a dependency condition for a capability parameter, input location, or output location.
 * Multiple @DependsOn annotations on the same target are combined with AND logic by default.
 */
...
/**
 * Declares a group of dependency conditions combined with OR logic (satisfied if ANY condition matches).
 */
@Target(AnnotationTarget.VALUE_PARAMETER, AnnotationTarget.PROPERTY, AnnotationTarget.FIELD)
@Retention(AnnotationRetention.SOURCE)
annotation class DependsOnAny(
    val conditions: Array<DependsOn>
)

/**
 * Declares a group of dependency conditions combined with AND logic (satisfied if ALL conditions match).
 */
@Target(AnnotationTarget.VALUE_PARAMETER, AnnotationTarget.PROPERTY, AnnotationTarget.FIELD)
@Retention(AnnotationRetention.SOURCE)
annotation class DependsOnAll(
    val conditions: Array<DependsOn>
)
