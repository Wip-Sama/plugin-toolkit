...
Changes:
	...
	- Now system nodes correctly have path/file path/folder (TODO)
	- Now SemanticTypes with only the base will accept any SemanticType with that base (TODO) (e.g. path will accept path/file)
Added:
