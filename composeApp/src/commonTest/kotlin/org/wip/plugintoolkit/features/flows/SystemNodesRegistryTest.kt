...
class SystemNodesRegistryTest {
    ...
    fun testErrorNodeConfiguration() {
        ...
        assertEquals<DataType>(DataType.Primitive(PrimitiveType.STRING), messagePort.dataType, "Message input should be STRING")
        assertEquals("An error occurred during flow execution", messagePort.defaultValue, "Message default value matches")
