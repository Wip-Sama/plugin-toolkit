...
actual object PluginSecurity {

    actual fun verify(jarPath: String, publicKeyBase64: String): Boolean {
        try {
    ...
    actual fun verifyDetached(data: String, signatureBase64: String, publicKeyBase64: String): Boolean {
        return try {
            val publicKey = loadPublicKey(publicKeyBase64)
