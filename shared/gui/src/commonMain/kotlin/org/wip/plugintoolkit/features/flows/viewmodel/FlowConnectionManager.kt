...
class FlowConnectionManager(
        ...
        if (typesCompatible && semanticsCompatible) {
            ...
            viewModelScope.launch {
                val message = if (!typesCompatible) {
                    ...
                    Res.string.flow_editor_incompatible_semantics.localizedWithArgs(
    ...
    fun handleAutoConvertAndConnect(
        ...
        var midPosition = org.wip.plugintoolkit.features.flows.model.Offset(
        ...
        while (currentState.flow.nodes.any { it.position == midPosition }) {
            midPosition = org.wip.plugintoolkit.features.flows.model.Offset(midPosition.x + 50f, midPosition.y + 50f)
        }
